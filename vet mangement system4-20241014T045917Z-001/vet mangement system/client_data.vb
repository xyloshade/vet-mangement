...
Public Class client_data
    ...
    Private Sub refreshMe()
        ...
        Try
            ...
            dgv_client.DefaultCellStyle.BackColor = Color.Bisque 
    ...
    Private Sub btn_update_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_update.Click
        ...
        Try
            ...
            With mycmd
                .Connection = con
                .CommandText = "update client_info set client_fname = '" & bt & "', client_lname= '" & ba & "', contact_num= '" & cn & "', address ='" & a & "', city= '" & vc & "', zip= '" & z & "', email= '" & em & "' ,pet_no= '" & p & "' , pet_name= '" & pn & "',pet_name2= '" & pn2 & "',pet_name3= '" & pn3 & "' where client_id= '" & cid & "'"
                .ExecuteNonQuery()
            End With
