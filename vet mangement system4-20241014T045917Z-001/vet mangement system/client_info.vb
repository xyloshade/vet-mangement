...
Public Class client_info
    ...
    Private Sub Btn_add_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_add.Click
        ...
        Try
            ...
            With mycmd
                .Connection = con
                .CommandText = "insert client_info values ('" & cid & "' ,'" & f & "','" & ln & "','" & cn & "','" & a & "','" & vc & "','" & z & "','" & em & "','" & p & "' ,'" & pn & "','" & pn2 & "' , '" & pn3 & "'  )"
                .ExecuteNonQuery()
            End With
    ...
    Private Sub ComboBox1_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles Cb_city.KeyDown
