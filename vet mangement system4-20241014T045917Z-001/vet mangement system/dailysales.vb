...
Public Class dailysales
    ...
    Private Sub RefreshDataGridView()
        Try
            ...
            dgv_dailysales.DefaultCellStyle.BackColor = Color.Bisque ' Set background color to bisque

            ' Set alternate row color for better readability
            Dim alternatingStyle As New DataGridViewCellStyle()
            alternatingStyle.BackColor = Color.LightSalmon ' Set alternating row color to light salmon
